...
def main():
    ...
    xml_input_file_0001 = os.path.join(emdb_xml2cif_translator.test_data.xml.__path__[0], "emd-1003-v30.xml")

    cif_output_file_0001 = os.path.join(emdb_xml2cif_translator.test_data.cif.__path__[0], "emd-1003.cif")
