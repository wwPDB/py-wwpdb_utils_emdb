...
def main():
    ...
    """
    usage = """
            xml_to_cif_translator.py [options]
            Convert a EMDB v3.x xml file to mmcif file
            
            Examples: 
            python xml_to_cif_translator.py -i input_xml_file -o output_cif_file
            
            Typical run:
            python xml_to_cif_translator.py -i in.xml -o out.cif
                in.xml: an EMDB XML file 3.x
                out.cif: a cif file in emd space
            
            python xml_to_cif_translator.py -i in.xml -o out.cif -d in.dic
                 in.dic: An mmcif dictionary that the out.cif is translated from
            """
    # print(usage)
    xml_input_file_0001 = "/Users/sanja/IdeaProjects/emdb-xml2cif-translator/data/xml/emd-0001.xml"

    cif_output_file_0001 = "/Users/sanja/IdeaProjects/emdb-xml2cif-translator/data/cif/emd-0001.cif"
